...
def main():
    ...
    outf=open("/srv/gsfs0/projects/ashley/common/myheart/results/feature_dataframes/activity_activity_proportions_full.tsv"+"_HIGHCONF_"+sys.argv[1]+"_"+sys.argv[2],'w')    
