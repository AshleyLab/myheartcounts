# Not run - temp notes for table 2
###
##################BELOW IS FOR REFERENCE, NOT USED. SCRIPT IS CALLED make_table.R and jump down to the bottom called Oct analysis
###
###
########### Table 2
###
...
###
###
###all<- load("~/Downloads/Table_2.bin", header=T,as.is=T)
...
###                     numberOfSteps = mean(numberOfSteps, na.rm=T), distance = mean(distance, na.rm=T), pActive=mean(pActive), satisfaction=median(satisfaction, na.rm=T))
###
