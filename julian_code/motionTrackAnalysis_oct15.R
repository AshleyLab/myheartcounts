...
indiv_all = read.table("/Users/Julian/Documents/AshleyLab/MHealth/MyHeartCounts_October15/MotionDataJulian/ind_motion_data1015.txt", sep="\t", head=T)

# Read in time data

time = read.table("/Users/Julian/Documents/AshleyLab/MHealth/MyHeartCounts_October15/MotionDataJulian/time_motion_data1015.txt", sep="\t", head=T)
