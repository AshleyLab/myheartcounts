...
age=subset(demographics,select=c("Subject","Age","Sex"))
merged=merge(pcvals,age,by.x="FID",by.y="Subject",all.x=TRUE)
write.table(merged,"covariates.txt",quote=FALSE,sep="\t",row.names=FALSE)
