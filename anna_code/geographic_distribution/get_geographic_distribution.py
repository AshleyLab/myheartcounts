...
#subjects=open("v1.zip",'r').read().strip().split('\n') 
#subjects=open("../zip/rct.zipcodes",'r').read().strip().split('\n') 
#subjects=open("v1.zip.shared.broadly",'r').read().strip().split('\n') 
...
outf_uk=open('23andme.uk.tally','w') 
