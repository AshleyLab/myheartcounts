...
healthkit_steps$Intervention=factor(healthkit_steps$Intervention,levels=c("Baseline","Stand","Cluster","ReadAHAWebsite","Walk","InterventionGap","PostIntervention"))
...
healthkit_steps_watch$Intervention=factor(healthkit_steps_watch$Intervention,levels=c("Baseline","Stand","Cluster","ReadAHAWebsite","Walk","InterventionGap","PostIntervention"))
...
healthkit_steps_phone$Intervention=factor(healthkit_steps_phone$Intervention,levels=c("Baseline","Cluster","ReadAHAWebsite","Stand","Walk","InterventionGap","PostIntervention"))
...
healthkit_distance$Intervention=factor(healthkit_distance$Intervention,levels=c("Baseline","Cluster","ReadAHAWebsite","Stand","Walk","InterventionGap","PostIntervention"))
...
healthkit_distance_watch$Intervention=factor(healthkit_distance_watch$Intervention,levels=c("Baseline","Cluster","ReadAHAWebsite","Stand","Walk","InterventionGap","PostIntervention"))
...
healthkit_distance_phone$Intervention=factor(healthkit_distance_phone$Intervention,levels=c("Baseline","Cluster","ReadAHAWebsite","Stand","Walk","InterventionGap","PostIntervention"))
