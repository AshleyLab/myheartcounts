...
# #WAVELETS 
 wavelets<-d[,1:20] 
 proportions<-d[,21:32]
names(proportions)=c("Automotive","","Cycling","","Running","", "Stationary","","Unknown","","Walking","")
...
# #PROPORTIONS 
 png('pca_proportion.png',width=7,height=7,units="in",res=600)
 biplot(pr.proportion,scale=0,xlabs=rep(".",17062),lwd=2,font=2)
 dev.off() 


png('pca_proportion_1_3.png',width=7,height=7,units="in",res=600)
 biplot(pr.proportion,choices=c(1,3),scale=0,xlabs=rep(".",17062))
 dev.off() 

 png('pca_proportion_2_3.png',width=7,height=7,units="in",res=600)
