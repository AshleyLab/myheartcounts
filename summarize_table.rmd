...
print(xtable(sleepoutlier1),size="tiny",include.rownames=F,floating=F)

sleepoutlier2 <- tail(data1[sleep.order,c("healthCode",vars2,"sleeptime","waketime")],10)
print(xtable(sleepoutlier2),size="tiny",include.rownames=F,floating=F)
...
## Distributions
```{r histograms1, warning=F,message=F,fig.width=5}
