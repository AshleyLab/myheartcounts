...
path = "~/PD_dream/Ldopa_proc_raw_features/all_training/merged"

message (paste0("processing ", kw, " ...  "))
input_dat = paste0(path, "/", kw, "_", ext, ".txt")
input_y = paste0(path, "/", kw, "_", ext, "_y.txt")
