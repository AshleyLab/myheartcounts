...
source_dir = '/scratch/PI/euan/projects/mhc/data/tables'
...
destination_filename = '/scratch/PI/euan/projects/mhc/code/daniel_code/combined_health_label_table.pkl'
...
final_table.to_pickle(destination_filename)
