...
#data.path <- "/home/anna/sherlock/data"
#cache.path <- "/home/anna/sherlock/data/synapseCache"
...
#for (j in c('syn3458480','syn3420486','syn4214144','syn4214144','syn4095792','syn3560085')) {
    ...
    #for (j in c('syn4536838','syn3560095','syn3560086','syn3458480','syn3420486','syn4214144','syn4095792','syn3560085','syn4857044')) {
for (j in c('syn3560085','syn4095792')) {
        ...
        # download
        theseFiles <- list()
	synDownloadTableColumns(tq, colNames)
        }
    }
